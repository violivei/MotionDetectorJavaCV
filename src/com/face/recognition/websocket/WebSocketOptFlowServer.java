...
@ServerEndpoint(value = "/OptFlowServerSocket", configurator = GetHttpSessionConfigurator.class)
public class WebSocketOptFlowServer {

	private Logger logger = Logger.getLogger(WebSocketTrackerServer.class);
	private static Set<Session> clients = Collections.synchronizedSet(new HashSet<Session>());
	private ExampleDenseOpticalFlow faceDetection;
...
//		        if(firstImage) {
//		        	faceDetection = new ExampleDenseOpticalFlow(imageData);
...
//		        }
		        faceDetection = new ExampleDenseOpticalFlow();
		        result = faceDetection.convert(imageData);
